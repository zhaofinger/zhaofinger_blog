  ...
  return (<article>
    <header>
      ...
      <div>
        ...
        <Link className='mr-2' href='/'>赵的拇指</Link>
        <span className='mr-2'>At</span>
        <span className='mr-2'>{ dayjs(+articleDetail.created_at).format('YYYY-MM-DD') }</span>
        <span className='mr-2'>In</span>
        <Link className='mr-2' href='/article/type/{{ articleDetail.type }}'>{articleDetail.type}</Link>
